...
export default function VersePuzzlePage() {
  ...
  const completed = isGameCompleted("verse-puzzle");

  const handleComplete = () => {
    completeGame("verse-puzzle", "verse-builder");
  };
      ...
      <div style={{ maxWidth: "640px", margin: "0 auto", padding: "24px 16px 80px" }}>
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          <p style={{ fontSize: "15px", color: "#7A4E2D", fontFamily: "'Nunito', sans-serif" }}>
            Build Genesis 1:1 from memory by clicking the words in order!
          </p>
        </div>
